...
//  ----------------------------------------------------------------------------*/
import getgravc from "./getgravc";
import gstime from "./gstime";

export default function initl(ecco, epoch, inclo, no, satn, gravc, opsmode = "i") {
    // /* -------------------- wgs-72 earth constants ----------------- */
    // sgp4fix identify constants and allow alternate values

    const [tumin, mu, raduisearchkm, xke, j2, j3, j4, j3oj2] = getgravc(gravc);
