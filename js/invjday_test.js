...
test("2456026.500000000000", function() {
    var rets = invjday(2456026.5);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 9);
    equal(hr, 0);
    equal(min, 0);
    ok(isequalRel(sec, 0.0, TOL));
});
...
test("2456026.656250000000", function() {
    var rets = invjday(2456026.65625);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 9);
...
test("2456026.968750000000", function() {
    var rets = invjday(2456026.96875);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 9);
...
test("2456027.281250000000", function() {
    var rets = invjday(2456027.28125);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 9);
...
test("2456027.593750000000", function() {
    var rets = invjday(2456027.59375);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 10);
...
test("2456027.906250000000", function() {
    var rets = invjday(2456027.90625);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 10);
...
test("2456028.218750000000", function() {
    var rets = invjday(2456028.21875);
    (year = rets.shift()), (mon = rets.shift()), (day = rets.shift()), (hr = rets.shift()), (min = rets.shift()), (sec = rets.shift());
    equal(year, 2012);
    equal(mon, 4);
    equal(day, 10);
