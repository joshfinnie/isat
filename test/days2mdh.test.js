...
describe('days2mdh', () => {
    ...
    it('2000, 179.784950620000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2000, 179.784950620000);
    ...
    it('2004, 31.910709590000', function () {
       let [mon, day, hr, minute, sec] = days2mdh(2004, 31.910709590000);
        expect(mon).to.be.equal(1);
    ...
    it('2006, 176.824120140000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.824120140000);
        expect(mon).to.be.equal(6);
    ...
    it('2006, 176.332154440000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.332154440000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
    ...
    it('2006, 176.561574750000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.561574750000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
    ...
    it('2005, 148.794179280000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2005, 148.794179280000);
    ...
    it('1980, 230.296297880000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(1980, 230.296297880000);
    ...
    it('2006, 176.028448930000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.028448930000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
        expect(hr).to.be.equal(0);
    ...
    it('2006, 151.674157710000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 151.674157710000);
        expect(mon).to.be.equal(5);
        expect(day).to.be.equal(31);
    ...
    it('2005, 363.791666670000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2005, 363.791666670000);
        expect(mon).to.be.equal(12);
    ...
    it('2006, 176.023412440000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.023412440000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
        expect(hr).to.be.equal(0);
    ...
    it('2006, 94.462359120000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 94.462359120000);
    ...
    it('2006, 176.559091070000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.559091070000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
        expect(hr).to.be.equal(13);
    ...
    it('2006, 175.457520520000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 175.457520520000);
        expect(mon).to.be.equal(6);
    ...
    it('1994, 305.499999990000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(1994, 305.499999990000);
    ...
    it('2006, 171.765354630000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 171.765354630000);
        expect(mon).to.be.equal(6);
    ...
    it('2006, 177.040617400000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 177.040617400000);
        expect(mon).to.be.equal(6);
    ...
    it('2004, 39.680572850000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2004, 39.680572850000);
        expect(mon).to.be.equal(2);
        expect(day).to.be.equal(8);
        expect(hr).to.be.equal(16);
    ...
    it('2006, 106.745032470000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 106.745032470000);
        expect(mon).to.be.equal(4);
    ...
    it('2006, 174.858188710000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 174.858188710000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(23);
        expect(hr).to.be.equal(20);
        expect(minute).to.be.equal(35);
        expect(sec).to.be.almost.equal(47.504544000640);
        // 26975
    });

    it('2006, 177.786158330000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 177.786158330000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(26);
        expect(hr).to.be.equal(18);
        expect(minute).to.be.equal(52);
    ...
    it('2006, 175.570711360000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 175.570711360000);
        expect(mon).to.be.equal(6);
        expect(day,).to.be.equal(24);
        expect(hr).to.be.equal(13);
    ...
    it('2006, 167.217886660000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 167.217886660000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(16);
    ...
    it('2006, 177.810791840000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 177.810791840000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(26);
        expect(hr).to.be.equal(19);
    ...
    it('2006, 176.466833970000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 176.466833970000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(25);
        expect(hr).to.be.equal(11);
    ...
    it('2005, 333.020126610000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2005, 333.020126610000);
        expect(mon).to.be.equal(11);
        expect(day).to.be.equal(29);
        expect(hr).to.be.equal(0);
        expect(minute).to.be.equal(28);
    ...
    it('2006, 170.267838450000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 170.267838450000);
        expect(mon).to.be.equal(6);
    ...
    it('2006, 177.287320100000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(2006, 177.287320100000);
        expect(mon).to.be.equal(6);
        expect(day).to.be.equal(26);
        expect(hr).to.be.equal(6);
    ...
    it('1980, 275.987084650000', function () {
        let [mon, day, hr, minute, sec] = days2mdh(1980, 275.987084650000);
