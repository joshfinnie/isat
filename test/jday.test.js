...
describe('jday', () => {
    it('should work with sample dates', () => {
        ...
        expect(jday(2012,  2,  8,  0, 0,  0)).to.be.equal(2455965.500000);       // aa.usno.navy.mil
    ...
    it('should work with dates from testmat.m run', () => {
        ...
        expect(jday(1980, 8, 17, 7, 6, 40.136831999771)).to.almost.equal(2444468.796297879890);
        expect(jday(2006, 6, 25, 0, 40, 57.987551999668)).to.almost.equal(2453911.528448930010);
        ...
        expect(jday(2006, 6, 23, 20, 35, 47.504544000640)).to.almost.equal(2453910.358188710175);
