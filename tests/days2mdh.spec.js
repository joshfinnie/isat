...
describe("days2mdh", () => {
    ...
    it("2000, 179.784950620000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2000, 179.78495062);
        expect(mon).toBe(6);
        expect(day).toBe(27);
        expect(hr).toBe(18);
        expect(minute).toBe(50);
        expect(isequalRel(sec, 19.733567999083, TOL)).toBe(true);
    });

    it("2004, 31.910709590000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2004, 31.91070959);
        expect(mon).toBe(1);
        expect(day).toBe(31);
        expect(hr).toBe(21);
        expect(minute).toBe(51);
        expect(isequalRel(sec, 25.308575999977, TOL)).toBe(true);
    });

    it("2006, 176.824120140000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.82412014);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(19);
        expect(minute).toBe(46);
        expect(isequalRel(sec, 43.980095999214, TOL)).toBe(true);
    });

    it("2006, 176.332154440000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.33215444);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(7);
    ...
    it("2006, 176.561574750000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.56157475);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(13);
    ...
    it("2005, 148.794179280000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2005, 148.79417928);
        expect(mon).toBe(5);
        expect(day).toBe(28);
        expect(hr).toBe(19);
    ...
    it("1980, 230.296297880000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(1980, 230.29629788);
        expect(mon).toBe(8);
        expect(day).toBe(17);
        expect(hr).toBe(7);
    ...
    it("2006, 176.028448930000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.02844893);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(0);
        expect(minute).toBe(40);
        expect(isequalRel(sec, 57.987551999668, TOL)).toBe(true);
    });

    it("2006, 151.674157710000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 151.67415771);
        expect(mon).toBe(5);
        expect(day).toBe(31);
        expect(hr).toBe(16);
    ...
    it("2005, 363.791666670000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2005, 363.79166667);
        expect(mon).toBe(12);
        expect(day).toBe(29);
        expect(hr).toBe(19);
        expect(minute).toBe(0);
    ...
    it("2006, 176.023412440000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.02341244);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(0);
        expect(minute).toBe(33);
        expect(isequalRel(sec, 42.834815998885, TOL)).toBe(true);
    });

    it("2006, 94.462359120000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 94.46235912);
        expect(mon).toBe(4);
        expect(day).toBe(4);
        expect(hr).toBe(11);
    ...
    it("2006, 176.559091070000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.55909107);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(13);
    ...
    it("2006, 175.457520520000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 175.45752052);
        expect(mon).toBe(6);
        expect(day).toBe(24);
        expect(hr).toBe(10);
        expect(minute).toBe(58);
    ...
    it("1994, 305.499999990000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(1994, 305.49999999);
        expect(mon).toBe(11);
        expect(day).toBe(1);
        expect(hr).toBe(11);
    ...
    it("2006, 171.765354630000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 171.76535463);
        expect(mon).toBe(6);
        expect(day).toBe(20);
        expect(hr).toBe(18);
        expect(minute).toBe(22);
    ...
    it("2006, 177.040617400000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 177.0406174);
        expect(mon).toBe(6);
        expect(day).toBe(26);
        expect(hr).toBe(0);
        expect(minute).toBe(58);
    ...
    it("2004, 39.680572850000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2004, 39.68057285);
        expect(mon).toBe(2);
        expect(day).toBe(8);
        expect(hr).toBe(16);
    ...
    it("2006, 106.745032470000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 106.74503247);
        expect(mon).toBe(4);
        expect(day).toBe(16);
        expect(hr).toBe(17);
    ...
    it("2006, 174.858188710000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 174.85818871);
        expect(mon).toBe(6);
        expect(day).toBe(23);
        expect(hr).toBe(20);
        expect(minute).toBe(35);
        expect(isequalRel(sec, 47.50454400064, TOL)).toBe(true);
    });

    it("2006, 177.786158330000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 177.78615833);
        expect(mon).toBe(6);
        expect(day).toBe(26);
        expect(hr).toBe(18);
        expect(minute).toBe(52);
    ...
    it("2006, 175.570711360000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 175.57071136);
        expect(mon).toBe(6);
        expect(day).toBe(24);
        expect(hr).toBe(13);
        expect(minute).toBe(41);
        expect(isequalRel(sec, 49.461503999137, TOL)).toBe(true);
    });

    it("2006, 167.217886660000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 167.21788666);
        expect(mon).toBe(6);
        expect(day).toBe(16);
        expect(hr).toBe(5);
    ...
    it("2006, 177.810791840000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 177.81079184);
        expect(mon).toBe(6);
        expect(day).toBe(26);
        expect(hr).toBe(19);
        expect(minute).toBe(27);
        expect(isequalRel(sec, 32.414976000637, TOL)).toBe(true);
    });

    it("2006, 176.466833970000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 176.46683397);
        expect(mon).toBe(6);
        expect(day).toBe(25);
        expect(hr).toBe(11);
    ...
    it("2005, 333.020126610000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2005, 333.02012661);
        expect(mon).toBe(11);
        expect(day).toBe(29);
        expect(hr).toBe(0);
        expect(minute).toBe(28);
    ...
    it("2006, 170.267838450000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 170.26783845);
        expect(mon).toBe(6);
        expect(day).toBe(19);
        expect(hr).toBe(6);
        expect(minute).toBe(25);
    ...
    it("2006, 177.287320100000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(2006, 177.2873201);
        expect(mon).toBe(6);
        expect(day).toBe(26);
        expect(hr).toBe(6);
        expect(minute).toBe(53);
        expect(isequalRel(sec, 44.456639998971, TOL)).toBe(true);
    });

    it("1980, 275.987084650000", () => {
        const [mon, day, hr, minute, sec] = days2mdh(1980, 275.98708465);
        expect(mon).toBe(10);
        expect(day).toBe(1);
        expect(hr).toBe(23);
        expect(minute).toBe(41);
