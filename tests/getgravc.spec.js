...
describe("getgravc", () => {
    it("WGS-72 low precision (721)", () => {
        ...
        expect(isequalRel(r.xke, 0.0743669161, TOL)).toBe(true);
        expect(isequalRel(r.j2, 0.001082616, TOL)).toBe(true);
        expect(isequalRel(r.j3, -0.00000253881, TOL)).toBe(true);
        expect(isequalRel(r.j4, -0.00000165597, TOL)).toBe(true);
        expect(isequalRel(r.j3oj2, -0.00234506972, TOL)).toBe(true);
    });
